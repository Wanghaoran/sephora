    ...
    <div class="content" id="content" data-q="n" data-style="questioner" data-a="n" data-share="n">
        ...
        <section class="screen" id="screen_2">
            ...
            <div class="s2_question" id="question">
                ...
                <h4>选出你的问题</h4>
                <ul class="s2_q_list">
                    <li data-list="q1"><span></span>问题1：姐最满意自己哪一部分？</li>
                    <li data-list="q2"><span></span>问题2：哪种男生是姐的菜？</li>
                    <li data-list="q3"><span></span>问题3：姐是什么Cup？</li>
                    <li data-list="q4"><span></span>问题4：我在朋友圈是什么卦？</li>
                    <li data-list="q5"><span></span>问题5：该不该看男人手机？</li>
